...
# url = "https://telex.hu/rss/archivum?filters=%7B%22parentId%22%3A%5B%22null%22%5D%7D&perPage=5"
# telex_feed = feedparser.parse(url)

# print(telex_feed['feed']['title'])
# print(len(telex_feed['items']))
# print(telex_feed['items'][0]['title'])
# print(telex_feed['items'][4]['title'])
